...
class DSAMM_Admin_Interface {
        ...
        if ( $locations_screen ) {
            ...
            ?>
                                ...
                                <span class="submit-btn">
                                    <button type="submit" id="menu_submit_button" class="button button-secondary" value="<?php 
            ...
            ?>" />
                            ...
                            <!-- Start menu revistion -->
                            <div id="amm_menu_revision">
                                <h3 class="menu_subheadings amm_ec_item"><?php 
            esc_html_e( 'Menu Revision Functionality', 'advance-menu-manager' );
            ?><span class="dsamm-pro-label"></span></h3>
                                <div class="amm_section_innter dsamm-upgrade-to-pro" style="display:none;">
                                    <div class="amm_menu_revision_content revision_div_pro">
                                        <div class="ammm_feature_title_wrapper">
                                            <h3><?php 
            esc_html_e( 'Menu Revision Functionality is ', 'advance-menu-manager' );
            ?><span class="Enabled"><?php 
            esc_html_e( 'Enabled ', 'advance-menu-manager' );
            ?></span>
                                            </h3>
                                            <div class="amm_menu_revision_footer save_menu_revision amm_right_section">
                                                <label class="switch">
                                                    <input checked="checked" id="amm_menu_revision_status_pro" name="amm_menu_revision_status_pro" type="checkbox" value="on">
                                                    <div class="slider round"></div>
                                                </label>
                                                <label for="amm_menu_revision_status_pro">
                                                    <b><?php 
            esc_html_e( 'Menu Revision Status ', 'advance-menu-manager' );
            ?></b>
                                                </label>
                                            </div>
                                            <!-- end amm_menu_revision_footer -->
                                        </div>
                                        <p><?php 
            esc_html_e( 'Shows history of different versions of menu revisions you did. You can start/stop revision for a particular menu if you have more than one menu. ', 'advance-menu-manager' );
            ?></p>
                                    </div>
                                    <!-- end amm_menu_revision_content -->
                                    <div class="amm_menu_revision_wrapper revision_div_pro" style="display:block">
                                        <p><?php 
            esc_html_e( 'List of Revisions for', 'advance-menu-manager' );
            ?><b> <?php 
            esc_html_e( 'Menu (July 31, 2024  10:42 am)', 'advance-menu-manager' );
            ?></b></p>
                                        <ul class="list_of_menu_revision">
                                            <li>
                                                <label class="menu_revision_date">
                                                    <input name="menu_revision_date" title="July 31, 2024  10:42 am" type="radio" value="2024-07-31 10:42:30" checked >
                                                    <b><?php 
            esc_html_e( '01', 'advance-menu-manager' );
            ?></b><?php 
            esc_html_e( '(July 31, 2024  10:42 am)', 'advance-menu-manager' );
            ?>
                                                </label>
                                            </li>
                                        </ul>
                                        <div id="flush-revision">
                                            <input class="button button-secondary flush-menu-revision-pro" name="flish_revision_pro" type="button" value="<?php 
            esc_attr_e( 'Flush Revision', 'advance-menu-manager' );
            ?>"/>
                                        </div>
                                        <div id="compare_revision" style="display: block;">
                                            <input class="button button-primary save-menu-revision-pro" name="compare_revision_pro" type="button" value="<?php 
            esc_attr_e( 'Restore This Revision', 'advance-menu-manager' );
            ?>">
                                        </div>
                                    </div>
                                    <div id="menu_revision_main_wrapper">
                                        <div class="view_menu_reviion_wrapper" style="display: block;">
                                            <div class="view_menu_reviion_current">
                                                <h3><?php 
            esc_html_e( 'Current Menu', 'advance-menu-manager' );
            ?></h3>
                                                <ul class="menu_revision">
                                                    <li class="menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive" data-depth="0">
                                                        <div class="menu-item-bar">
                                                            <div class="menu-item-handle ui-sortable-handle ">
                                                                <span class="item-title">
                                                                    <span class="menu-item-title" id="manu-manager-plus-title"><?php 
            esc_html_e( 'Shop', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="is-submenu"><?php 
            esc_html_e( 'sub item', 'advance-menu-manager' );
            ?></span>
                                                                ...
                                                                <span class="item-controls">
                                                                    <span class="menu_item_type"><?php 
            esc_html_e( 'Shop Page', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="menu_sub_details"></span>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive" data-depth="0">
                                                        <div class="menu-item-bar">
                                                            <div class="menu-item-handle ui-sortable-handle ">
                                                                <span class="item-title">
                                                                    <span class="menu-item-title" id="manu-manager-plus-title"><?php 
            esc_html_e( 'Cart', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="is-submenu"><?php 
            esc_html_e( 'sub item', 'advance-menu-manager' );
            ?></span>
                                                                ...
                                                                <span class="item-controls">
                                                                    <span class="menu_item_type"><?php 
            esc_html_e( 'Cart Page', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="menu_sub_details"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <li class="menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive" data-depth="0">
                                                        <div class="menu-item-bar">
                                                            <div class="menu-item-handle ui-sortable-handle ">
                                                                <span class="item-title">
                                                                    <span class="menu-item-title" id="manu-manager-plus-title"><?php 
            esc_html_e( 'Checkout', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="is-submenu"><?php 
            esc_html_e( 'sub item', 'advance-menu-manager' );
            ?></span>
                                                                ...
                                                                <span class="item-controls">
                                                                    <span class="menu_item_type"><?php 
            esc_html_e( 'Checkout Page', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="menu_sub_details"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <li class="menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive" data-depth="0">
                                                        <div class="menu-item-bar">
                                                            <div class="menu-item-handle ui-sortable-handle ">
                                                                <span class="item-title">
                                                                    <span class="menu-item-title" id="manu-manager-plus-title"><?php 
            esc_html_e( 'May Account', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="is-submenu"><?php 
            esc_html_e( 'sub item', 'advance-menu-manager' );
            ?></span>
                                                    ...
                                                    <li class="menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive" data-depth="0">
                                                        <div class="menu-item-bar">
                                                            <div class="menu-item-handle ui-sortable-handle ">
                                                                <span class="item-title">
                                                                    <span class="menu-item-title" id="manu-manager-plus-title"><?php 
            esc_html_e( 'Sample Page', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="is-submenu"><?php 
            esc_html_e( 'sub item', 'advance-menu-manager' );
            ?></span>
                                                                ...
                                                                <span class="item-controls">
                                                                    <span class="menu_item_type"><?php 
            esc_html_e( 'Page', 'advance-menu-manager' );
            ?></span>
                                                                    <span class="menu_sub_details"></span>
                                                                </span>
                                                            </div>
                                            ...
                                            <div id="view_menu_reviion">
                                                <h3><?php 
            esc_html_e( 'Menu Revision: July 31, 2024  10:42 am', 'advance-menu-manager' );
            ?></h3>
                                                <ul class="menu_revision">
                                                    <li class="menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive" data-depth="0">
                                                        <div class="menu-item-bar">
            ...
            ?></span>
                                    ...
                                    <div class="amm_menu_revision_wrapper" id="page_bottom_revision_list" style="display: block;">
                                        <div id="compare_revision">
                                            <input class="button button-primary save-menu-revision-pro" name="compare_revision_pro" type="button" value="<?php 
            esc_attr_e( 'Restore This Revision', 'advance-menu-manager' );
            ?>">
                                        </div>
                            ...
                            <div class="lock-main">
                                <h3 class="menu_subheadings amm_ec_item"><?php 
            esc_html_e( 'Menu Lock Functionality', 'advance-menu-manager' );
            ?><span class="dsamm-pro-label"></span></h3>
                                <div class="amm_section_innter dsamm-upgrade-to-pro" style="display:none;">
                                    <div id="amm_menu_locked">
                                        <div class="amm_menu_locked_content">
                                            <div class="ammm_feature_title_wrapper amm_locked_menu_head_wrapper">
                                                <h3><?php 
            esc_html_e( 'Menu Lock Functionality is ', 'advance-menu-manager' );
            ?><span class="amm_locked_status" id="Enabled"><?php 
            esc_html_e( 'Enabled', 'advance-menu-manager' );
            ?></span></h3>
                                                <div class="enabled_Disabled amm_right_section">
                                                    <label class="switch amm_menu_locked_status">
                                                        <input checked='"checked"' id="amm_menu_locked_status_pro" name="amm_menu_locked_status_pro" type="checkbox" value="Enabled" checked>
                                                        <div class="slider round"></div>
                                                    </label>
                                                    <label for="amm_menu_locked_status_pro">
                                                        <strong><?php 
            esc_html_e( 'Menu Lock Status', 'advance-menu-manager' );
            ?></strong>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="amm_menu_locked_description" id="menu_locked_user_list">
                                                <strong><?php 
            esc_html_e( 'Please select users from the below list to whom you want to allow permission to edit this menu.', 'advance-menu-manager' );
            ?></strong>
                                                <ul class="amm_locked_user_data_list" name="user_locked">
                                                    <li>
                                                        <input class="amm_locked_user_checkbox" id="2" name="amm_locked_user[]" type="checkbox" value="2">
                                                        <label for="2"><?php 
            esc_html_e( 'User 1', 'advance-menu-manager' );
            ?></label>
                                                    </li>
                                                    <li>
                                                        <input class="amm_locked_user_checkbox" id="2" name="amm_locked_user[]" type="checkbox" value="2">
                                                        <label for="2"><?php 
            esc_html_e( 'User 2', 'advance-menu-manager' );
            ?></label>
                                                    </li>
                                                </ul>
                                                <div class="amm_menu_locked_submit_wrapper">
                                                    <input class="button-primary" id="amm_locked_this_menu_pro" type="button" value="Lock Menu">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- End menu lock -->
                            <!-- Start menu-shortcode -->
                            <div class="shortcode-main">
                                <h3 class="menu_subheadings amm_ec_item"><?php 
            esc_html_e( 'Menu Shortcode', 'advance-menu-manager' );
            ?><span class="dsamm-pro-label"></span></h3>
                                <div id="amm_menu_shortcode_wrapper" class="amm_section_innter dsamm-upgrade-to-pro" style="display:none;">
                                    <div class="amm_shortcode_content">
                                        <div class="ammm_feature_title_wrapper">
                                            <h3><?php 
            esc_html_e( 'Menu Shortcode', 'advance-menu-manager' );
            ?> :</h3>
                                            <div class="amm_menu_shortcode amm_right_section">[amm_menu menu_name="Header menu"]</div>
                                        </div>
                                        <p><?php 
            esc_html_e( 'Use this feature to copy your menu structure. Just copy and paste the code in the page/post where you require. The same menu shall appear in that page/post.', 'advance-menu-manager' );
            ?></p>
                                        <p>
                                            <b><?php 
            esc_html_e( 'More arguments', 'advance-menu-manager' );
            ?>:</b>  &nbsp;&nbsp;&nbsp;[amm_menu menu_name="your_menu_name" menu_class="your-class" container="your-container" container_id="your-containerid" container_class="your-container_class"]
                                        </p>
                                        <p><b class="revision_argument_title"><?php 
            esc_html_e( 'Arguments Description', 'advance-menu-manager' );
            ?>:</b></p>
                                        <div class="menu_argument_description">
                                            <ul>
                                                <li> <b class="dec_title">'menu_name':</b> (string) <?php 
            esc_html_e( 'Desired menu. Accepts (matching in order)', 'advance-menu-manager' );
            ?> id, slug, name. </li>
                                                <li> <b class="dec_title">'menu_class':</b> (string) <?php 
            esc_html_e( 'CSS class to use for the ul element which forms the menu. Default', 'advance-menu-manager' );
            ?> 'menu'.</li>
                                                <li> <b class="dec_title">'container':</b> (string) <?php 
            esc_html_e( 'Whether to wrap the ul, and what to wrap it with. Default', 'advance-menu-manager' );
            ?> 'div'.</li>
                                                <li> <b class="dec_title">'container_class':</b> (string) <?php 
            esc_html_e( 'Class that is applied to the container. Default', 'advance-menu-manager' );
            ?> 'menu-{menu slug}-container'.</li>
                                                <li> <b class="dec_title">'container_id':</b> (string) <?php 
            esc_html_e( 'The ID that is applied to the container.', 'advance-menu-manager' );
            ?></li>
                                            </ul>
                                        </div>
                                    </div>
     ...
     * 
     */
    public static function dsamm_plugin_setup_wizard_submit() {
        ...
        if ( !empty( $survey_list ) && 'Select One' !== $survey_list ) {
            update_option( 'dsamm_where_hear_about_us', $survey_list );
        }
        wp_die();
    }
     ...
     * 
     */
    public static function dsamm_send_wizard_data_after_plugin_activation() {
        ...
        if ( isset( $send_wizard_data ) && !empty( $send_wizard_data ) ) {
            if ( !get_option( 'dsamm_data_submited_in_sendiblue' ) ) {
                $dsamm_where_hear = get_option( 'dsamm_where_hear_about_us' );
                $get_user = ammp_fs()->get_user();
                $data_insert_array = array();
                if ( isset( $get_user ) && !empty( $get_user ) ) {
                    $data_insert_array = array(
                        'user_email'              => $get_user->email,
                        'ACQUISITION_SURVEY_LIST' => $dsamm_where_hear,
                    );
                }
                $feedback_api_url = DSAMM_STORE_URL . 'wp-json/dotstore-sendinblue-data/v2/dotstore-sendinblue-data?' . wp_rand();
                ...
                if ( !is_wp_error( $response ) && 200 === wp_remote_retrieve_response_code( $response ) ) {
                    update_option( 'dsamm_data_submited_in_sendiblue', '1' );
                    delete_option( 'dsamm_where_hear_about_us' );
                }
            }
        }
    }
     ...
     * @return null
     */
    public function dsamm_get_promotional_bar( $plugin_slug = '' ) {
        $promotional_bar_upi_url = DSAMM_STORE_URL . 'wp-json/dpb-promotional-banner/v2/dpb-promotional-banner?' . wp_rand();
     ...
     * @since 3.1.0
     */
    public static function dsamm_admin_footer_review() {
        $url = '';
        $url = esc_url( 'https://wordpress.org/plugins/advance-menu-manager/#reviews' );
        $html = sprintf( wp_kses( __( '<strong>We need your support</strong> to keep updating and improving the plugin. Please <a href="%1$s" target="_blank">help us by leaving a good review</a> :) Thanks!', 'advance-menu-manager' ), array(
            'strong' => array(),
            'a'      => array(
                'href'   => array(),
                'target' => 'blank',
