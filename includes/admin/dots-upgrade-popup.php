...
$plugin_slug = 'menu_manager';
$get_discounts_api = DSAMM_STORE_URL . 'wp-json/dots-upgrade-plugin-discounts/v2/dots-upgrade-plugin-discounts?' . wp_rand();
        ...
        <div class="pro-modal-inner">
            <div class="pro-modal-wrapper">
                <div class="pro-modal-header">
                    <img src="<?php echo esc_url( DSAMM_PRO_PLUGIN_URL . 'includes/admin/images/premium-upgrade-img/upgrade-rocket-img.png' ); ?>" alt="<?php esc_attr_e( 'Upgrade to Pro', 'advance-menu-manager' ); ?>">
                ...
                <div class="pro-modal-body">
                    ...
                    if ( ! empty( $discount_number ) ) {
                        ?>
                        <h3 class="pro-feature-title"><?php echo sprintf( esc_html__( 'Unlock Premium Features with a %s%% Discount!', 'advance-menu-manager' ), esc_html( $discount_number ) ); ?></h3>
                        <?php
                    } else {
                        ?>
                        <h3 class="pro-feature-title"><?php echo esc_html__( 'Unlock Premium Features Today!', 'advance-menu-manager' ); ?></h3>
                        <?php
                    }
                    ?>
                    <p><?php esc_html_e( 'Unlock a world of possibilities for your WooCommerce store with our Premium Advance Menu Manager plugin!', 'advance-menu-manager' ); ?></p>
                    <ul class="pro-feature-list">
                        <li><?php esc_html_e( 'Track, compare, and Restore menu changes.', 'advance-menu-manager' ); ?></li>
                        <li><?php esc_html_e( 'Streamline complex menu navigation.', 'advance-menu-manager' ); ?></li>
                        <li><?php esc_html_e( 'Manage pages and posts efficiently.', 'advance-menu-manager' ); ?></li>
                        <li><?php esc_html_e( 'Secure menu editing with user permissions.', 'advance-menu-manager' ); ?></li>
                    </ul>
                </div>
                <div class="pro-modal-footer">
                    <a class="pro-feature-trial-btn upgrade-now" target="_blank" href="javascript:void(0);"><?php esc_html_e( 'Upgrade Now', 'advance-menu-manager' ); ?></a>
                </div>
            </div>
        </div>
    </div>
